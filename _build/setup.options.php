...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install AnchorsAway</h2>

        <p>Thanks for installing AnchorsAway. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade AnchorsAway</h2>

        <p>AnchorsAway will be upgraded. This open source extra was developed by
